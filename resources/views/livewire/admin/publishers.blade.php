            ...
            <tbody>
                @forelse ($publishers as $publisher)
                    <tr wire:key="publisher-{{ $publisher->id }}">
                        ...
                        <td>
                            <span class="badge {{ $publisher->is_active ? 'badge-active' : 'badge-hidden' }}">
                        ...
                        <td>
                            <div style="display:flex;gap:.5rem">
                                ...
                                <button type="button" wire:click="delete({{ $publisher->id }})" wire:confirm="Delete this publisher?" class="btn-danger">Delete</button>
                            </div>
                        </td>
                    </tr>
                @empty
